...
const Footer = () => {
  ...
  <div className="max-w-[1400px] mx-auto p-4 md:px-9 text-right space-y-4">
    ...
    <p className="text-secondary-foreground/40 text-sm">
        Lorem, ipsum dolor sit amet consectetur adipisicing elit. Possimus adipisci reiciendis debitis repellat. <br/><Link to="/"><b> Perspiciatis </b></Link> fugiat debitis provident quibusdam ad dolorem tenetur vel similique sequi rerum! Necessitatibus obcaecati fuga soluta perspiciatis!
    </p>
  </div>
</div>
}
